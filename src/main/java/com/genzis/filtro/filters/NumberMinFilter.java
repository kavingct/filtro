...
/**
 * Filter to check if given number is greater than or equal to the given limit.
 * @author Kavin Subramanian
 *
 * @param <T> Filter type
 */
public class NumberMinFilter<T extends Number> implements Filter<T> {
	private T limit;
	 ...
	 */
	public NumberMinFilter(T limit)
	{
		this.limit = limit;
	}
